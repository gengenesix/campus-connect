    ...
    <>
      ...
      <div style={{ background: '#FAFAF8', borderBottom: '1px solid #E8E5E0', padding: '12px 20px' }}>
        <div className="container" style={{ display: 'flex', gap: '8px', alignItems: 'center', fontSize: '13px', color: '#9A9590' }}>
          ...
          <span>›</span>
          <Link href="/services" style={{ color: '#9A9590', textDecoration: 'none' }}>Services</Link>
          <span>›</span>
          <span style={{ color: '#1B5E20', fontWeight: 600 }}>{service.name}</span>
        </div>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: '48px', alignItems: 'start' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '8px', marginTop: '12px', flexWrap: 'wrap' }}>
              <span style={{ padding: '5px 12px', background: '#1B5E20', color: '#fff', fontWeight: 700, fontSize: '11px', letterSpacing: '0.5px', borderRadius: '20px' }}>
            ...
            {service.availability && (
              <div style={{ marginTop: '20px', border: '1px solid #86efac', borderRadius: '12px', padding: '16px', background: '#e8f5e9' }}>
          ...
          <div>
            ...
            <div style={{ border: '1px solid #E8E5E0', padding: '20px', background: '#fff', marginBottom: '20px', borderRadius: '14px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
              <div style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '1.5px', marginBottom: '12px', color: '#9A9590' }}>SERVICE PROVIDER</div>
            ...
            <div style={{ padding: '14px 16px', background: '#e8f5e9', border: '1px solid #86efac', borderRadius: '10px', fontSize: '13px', color: '#1B5E20', lineHeight: 1.5 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
              {related.map(s => (
                <Link key={s.id} href={`/services/${s.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                  <div style={{ border: '1px solid #E8E5E0', background: '#fff', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                    ...
                    <div style={{ padding: '12px' }}>
                      ...
                      <div style={{ fontFamily: '"Syne", sans-serif', fontSize: '16px', color: '#1B5E20' }}>{s.rate ?? 'Contact for pricing'}</div>
                    </div>
                  </div>
                </Link>
              ))}
