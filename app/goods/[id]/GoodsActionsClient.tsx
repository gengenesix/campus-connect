  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '24px' }}>
      <button
        ...
        style={{ width: '100%', padding: '16px 40px', fontFamily: '"Syne", sans-serif', fontSize: '15px', border: '2px solid #111', boxShadow: '4px 4px 0 #111', cursor: 'pointer', letterSpacing: '0.5px', background: '#111', color: '#fff' }}
      >
      ...
      {whatsappHref ? (
        <a
          ...
          style={{ textAlign: 'center', display: 'block', textDecoration: 'none', padding: '14px 40px', background: '#25D366', color: '#fff', fontFamily: '"Syne", sans-serif', fontSize: '14px', border: '2px solid #111', boxShadow: '4px 4px 0 #111', letterSpacing: '0.5px' }}
        >
          <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
        ...
        <Link
          ...
          style={{ textAlign: 'center', display: 'block', textDecoration: 'none', padding: '14px 40px', background: '#888', color: '#fff', fontFamily: '"Syne", sans-serif', fontSize: '14px', border: '2px solid #111', boxShadow: '4px 4px 0 #111', letterSpacing: '0.5px' }}
        >
          <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
